...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 min-h-screen bg-gradient-to-br from-rose-200 via-sky-200 to-violet-300 dark:from-slate-950 dark:via-indigo-950 dark:to-fuchsia-950 transition-colors">
      ...
      <hr className="my-10 border-white/60 dark:border-white/15" />

      {/* ================= 이용약관 ================= */}
      <section id="terms" className="space-y-8">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50">제1장 이용약관</h2>

        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제1조 (목적)</h3>
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제2조 (용어의 정의)</h3>
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제3조 (약관의 효력 및 변경)</h3>
          <p className="text-sm leading-relaxed text-slate-700 dark:text-slate-300">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제4조 (서비스의 제공 및 변경)</h3>
          <ul className="list-disc pl-5 text-sm text-slate-700 dark:text-slate-300 space-y-1">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제5조 (이용자의 의무)</h3>
          <ul className="list-disc pl-5 text-sm text-slate-700 dark:text-slate-300 space-y-1">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제6조 (책임의 제한)</h3>
          <p className="text-sm leading-relaxed text-slate-700 dark:text-slate-300">
      ...
      <hr className="my-12 border-white/60 dark:border-white/15" />

      {/* ================= 개인정보처리방침 ================= */}
      <section id="privacy" className="space-y-8">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50">제2장 개인정보처리방침</h2>

        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제7조 (수집하는 개인정보 항목)</h3>
          <ul className="list-disc pl-5 text-sm text-slate-700 dark:text-slate-300 space-y-1">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제8조 (개인정보의 이용 목적)</h3>
          <p className="text-sm text-slate-700 dark:text-slate-300">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제9조 (개인정보의 보관 및 이용 기간)</h3>
          <p className="text-sm text-slate-700 dark:text-slate-300">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제10조 (개인정보의 제3자 제공)</h3>
          <p className="text-sm text-slate-700 dark:text-slate-300">
        ...
        <article className="space-y-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">제11조 (이용자의 권리)</h3>
          <p className="text-sm text-slate-700 dark:text-slate-300">
