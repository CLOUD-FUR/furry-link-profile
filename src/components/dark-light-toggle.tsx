...
export function DarkLightToggle() {
  ...
  const showOnPaths = ["/", "/login", "/register", "/user", "/questions"];
  ...
  return (
    <button
      ...
      className="fixed bottom-[env(safe-area-inset-bottom,1rem)] right-4 sm:bottom-6 sm:right-6 z-[10000] flex h-14 w-14 items-center justify-center rounded-full border-2 border-white/70 bg-white/95 shadow-[0_15px_40px_-10px_rgba(15,23,42,0.5)] transition-colors hover:bg-white active:scale-95 dark:border-white/25 dark:bg-slate-900/95 dark:hover:bg-slate-800"
